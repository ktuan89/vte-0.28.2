...
{
  fprintf(stderr, "Text modified handle\n");
	VteTerminalAccessiblePrivate *priv;
	char *old, *current;
...
{
  fprintf(stderr, "vte_terminal_initialize\n");
	VteTerminal *terminal;
	AtkObject *parent;
...
{
  fprintf(stderr, "Here vte_terminal_accessible_new\n");
...
{
  fprintf(stderr, "vte_terminal_accessible_factory_create_accessible\n");
...
{
  fprintf(stderr, "vte_terminal_accessible_factory_new\n");
	_vte_debug_print(VTE_DEBUG_ALLY,
